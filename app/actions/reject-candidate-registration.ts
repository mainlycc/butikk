...
export type RejectCandidateRegistrationResult = {
  success: boolean
  error?: string
}

export async function rejectCandidateRegistration(
  registrationId: string,
  reason?: string
): Promise<RejectCandidateRegistrationResult> {
  try {
    ...
    console.error("Error in rejectCandidateRegistration:", error)
