      ...
      <div className="space-y-8 text-sm sm:text-base leading-relaxed text-muted-foreground">
        <section className="space-y-2">
          ...
          <p>
            ...
            internetowy prowadzony przez Deskset, z siedzibą w Krakowie (dalej: &ldquo;Administrator&rdquo;).
          </p>
          <p>
            ...
            szczególności Rozporządzeniem Parlamentu Europejskiego i Rady (UE) 2016/679 (&ldquo;RODO&rdquo;).
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>usunięcia (&ldquo;prawo do bycia zapomnianym&rdquo;),</li>
